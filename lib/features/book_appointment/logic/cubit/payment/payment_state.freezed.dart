...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CreditCard> savedCards,  CardType cardType,  String paymentMethod,  CreditCard? creditCard,  String? paymentIntentId,  bool isSuccess,  bool isLoading,  bool isError,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentState() when $default != null:
return $default(_that.savedCards,_that.cardType,_that.paymentMethod,_that.creditCard,_that.paymentIntentId,_that.isSuccess,_that.isLoading,_that.isError,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CreditCard> savedCards,  CardType cardType,  String paymentMethod,  CreditCard? creditCard,  String? paymentIntentId,  bool isSuccess,  bool isLoading,  bool isError,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _PaymentState():
return $default(_that.savedCards,_that.cardType,_that.paymentMethod,_that.creditCard,_that.paymentIntentId,_that.isSuccess,_that.isLoading,_that.isError,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CreditCard> savedCards,  CardType cardType,  String paymentMethod,  CreditCard? creditCard,  String? paymentIntentId,  bool isSuccess,  bool isLoading,  bool isError,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _PaymentState() when $default != null:
return $default(_that.savedCards,_that.cardType,_that.paymentMethod,_that.creditCard,_that.paymentIntentId,_that.isSuccess,_that.isLoading,_that.isError,_that.errorMessage);case _:
  return null;
