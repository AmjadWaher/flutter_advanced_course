...
class _AppointmentApiService implements AppointmentApiService {
  ...
  @override
  Future<AppointmentsResponse> getAppointmentByPatientId() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AppointmentsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Appointment/ByPatient',
    ...
    late AppointmentsResponse _value;
    try {
      _value = AppointmentsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
